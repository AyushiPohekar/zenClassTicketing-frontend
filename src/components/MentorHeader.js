          ...
          <div className="avtar ">
            {logindata.ValidMentorOne ? (
              <Avatar
                ...
                onClick={handleClick}
              >
                {logindata.ValidMentorOne.fname[0].toUpperCase()}
              </Avatar>
            ) : (
              <Avatar
